...
/// Progression TDD :
///
/// - Les 3 premiers tests (1, 2, 3) vous font découvrir la triangulation : commencez par un
///   `return "1";` en dur, puis généralisez progressivement.
/// - Les tests 4 à 9 ajoutent Buzz, FizzBuzz et les multiples plus éloignés.
/// - Les 3 derniers tests passent de `fizzBuzz(int)` (une valeur) à `fizzBuzzJusquA(int)`
///   (séquence complète).
